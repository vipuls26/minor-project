  ...
  >
    Upcoming Events
      ...
      <div class="flex items-center gap-3">
        ...
        <button
          @click="toggleMenu"
          class="inline-flex items-center justify-center rounded-lg p-2 text-zinc-900 transition-colors duration-200 hover:bg-zinc-50 hover:text-indigo-600 focus-visible:outline-2 focus-visible:outline-indigo-500 dark:text-zinc-100 dark:hover:bg-zinc-900 dark:hover:text-indigo-400 md:hidden"
    ...
    <transition name="fade">
      <div
        v-show="isMenuOpen"
        class="border-t border-zinc-200 bg-white/95 px-4 py-3 shadow-sm backdrop-blur-sm dark:border-white/10 dark:bg-zinc-950/95 md:hidden"
      >
